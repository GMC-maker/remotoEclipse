...
public class PaginaPrueba2 {
	...
	public static void main(String[] args) {
		...
		driver.get("http://opencart.abstracta.us/"); //pagina de pruebas
		 ...
		 * textBox.sendKeys("Selenium"); submitButton.click(); driver.quit();
		 */
		...
		driver.findElement(
				By.cssSelector("body > main > div > form > div > div:nth-child(2) > label:nth-child(3) > input"));
		driver.findElement(By.xpath("/html/body/main/div/form/div/div[2]/label[3]/input"))
				.sendKeys("C:\\Users\\Windows 11\\Downloads\\Guía Selenium.pdf");
